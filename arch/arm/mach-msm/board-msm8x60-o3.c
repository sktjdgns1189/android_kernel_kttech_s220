...
#define MIPI_VIDEO_DUMMY_VGA	"mipi_video_dummy_wvga"
#endif
...
#if defined(CONFIG_KTTECH_CAMERA_MT9M114) || defined(CONFIG_KTTECH_CAMERA_MT9M113)
...
//0118 boba
#ifdef CONFIG_KTTECH_CAMERA_MT9M113
...
#include "devices-kttech-o3/devices-tsp-kttech-o3.c"
#else
...
#ifdef CONFIG_KTTECH_BT_BCM4329
...
static struct rpm_regulator_init_data rpm_regulator_init_data[] = {
...
#if defined(CONFIG_KTTECH_SENSOR_CAPELLA_O6) || defined(CONFIG_KTTECH_SENSOR_CAPELLA_O3)
	RPM_LDO(PM8058_L2,  0, 1, 0, 2700000, 2700000, LDO300HMIN),
#else
	RPM_LDO(PM8058_L2,  0, 1, 0, 1800000, 2600000, LDO300HMIN),
#endif /* CONFIG_KTTECH_SENSOR_CAPELLA_O6, CONFIG_KTTECH_SENSOR_CAPELLA_O3 */
#ifdef CONFIG_KTTECH_PN544_NFC
...
#if defined(CONFIG_KTTECH_CAMERA_MT9M113) ||defined(CONFIG_KTTECH_CAMERA_MT9M114) || defined(CONFIG_KTTECH_CAMERA_MT9E013) || defined(CONFIG_KTTECH_CAMERA_S5K4E5) //0118 boba
...
#endif
#if defined(CONFIG_KTTECH_CAMERA_MT9E013) || defined(CONFIG_KTTECH_CAMERA_S5K4E5)
  ...
  RPM_LDO(PM8058_L19, 0, 1, 0, 2500000, 2500000, LDO150HMIN), 
	...
	RPM_LDO(PM8058_L22, 0, 1, 0, 1250000, 1250000, LDO300HMIN),
...
#if defined(CONFIG_KTTECH_SENSOR_CAPELLA_O6) || defined(CONFIG_KTTECH_SENSOR_AVAGO_O6) || defined(CONFIG_KTTECH_SENSOR_CAPELLA_O3)
	RPM_LDO(PM8901_L3,  0, 1, 0, 3000000, 3000000, LDO300HMIN),
#else
	RPM_LDO(PM8901_L3,  0, 1, 0, 3300000, 3300000, LDO300HMIN),
#endif /* #if defined(CONFIG_KTTECH_SENSOR_CAPELLA_O6) || defined(CONFIG_KTTECH_SENSOR_AVAGO_O6) || defined(CONFIG_KTTECH_SENSOR_CAPELLA_O3)*/
...
static struct pmic8058_led pmic8058_flash_leds[] = {
	...
	[2] = {
		...
		.max_brightness = 2, /* 2mA * 6 = Max 12mA */
...
#ifdef CONFIG_MMC_MSM_SDC4_SUPPORT
#ifdef CONFIG_KTTECH_WIFI_BCM4329
    /* SDCC4 : WLAN BCM4329 chip is connected */
...
#include "devices-kttech-o3/devices-mipi-novatek-kttech.c"
#else /* CONFIG_KTTECH_MIPI_NOVATEK */
static int mipi_dsi_panel_power(int on)
{
	int flag_on = !!on;
...
#ifdef CONFIG_KTTECH_WIFI_BCM4329
#define KTTECH_GPIO_WIFI_REG_ON      (51)     // WIFI_BT_REG_ON
...
#ifdef CONFIG_KTTECH_BT_BCM4329     //KTTECH_BT (WIFI_BT_REG_ON Control)
