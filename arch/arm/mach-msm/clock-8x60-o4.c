...
static struct clk_freq_tbl clk_tbl_pixel_mdp[] = {
	...
	F_PIXEL_MDP( 24700000, pll8, 1,   2,   31), // lcdc driver의 pinfo->clk_rate 와 같이 수정 /* 24.7MHz - DMB 성능 저하로 pclk 수정 */ 
#else
...
static struct clk_lookup msm_clocks_8x60[] = {
	...
	CLK_LOOKUP("csi_clk",		csi1_clk.c, "msm_camera_mt9d115.0"),
#endif
...
#ifdef CONFIG_KTTECH_CAMERA_MT9D115  // htdo_0503
	CLK_LOOKUP("csi_vfe_clk",	csi1_vfe_clk.c, "msm_camera_mt9d115.0"),
#endif
...
#ifdef CONFIG_KTTECH_CAMERA_MT9D115 // htdo_0503
	CLK_LOOKUP("csi_pclk",		csi1_p_clk.c, "msm_camera_mt9d115.0"),
#endif
...
static void __init msm8660_clock_init(void)
{
	...
	vote_vdd_level(&vdd_dig, VDD_DIG_HIGH);
         ...
         //kyuhak.choi/2012/0628/kt_tech require.
