...
#if defined(CONFIG_KTTECH_MODEL_O4) && !defined(KTTECH_FINAL_BUILD)
extern void ion_carveout_kttech_print_debug(void);
extern void ion_cp_kttech_print_debug(void);
#endif
...
#if defined(CONFIG_KTTECH_MODEL_O4) && !defined(KTTECH_FINAL_BUILD)
	ion_carveout_kttech_print_debug();
	ion_cp_kttech_print_debug();
#endif
