/*
*  qt602240_kttech_v3.h - Atmel maXTouch Touchscreen Controller
*
*  Version 0.3a
*
...
/*For Factory*/
//#define MXT_FACTORY_TEST  1 /*for TS factory test */
...
/*Normal Feature*/
#undef MXT_SLEEP_POWEROFF 
#define MXT_ESD_WORKAROUND
#undef MXT_ADV_PARM_DEFENCE
...
/* 3 Touch key array */
#define	TOUCH_3KEY_MENU	0x00
#define	TOUCH_3KEY_HOME	0x01
#define	TOUCH_3KEY_BACK	0x02
#define TOUCH_KEY_NULL  0x03

/* Touchscreen Key Positions : X */
#define TOUCH_3KEY_MENU_WITDTH 150
#define TOUCH_3KEY_HOME_WITDTH 150
#define TOUCH_3KEY_BACK_WITDTH 150
#define TOUCH_3KEY_MENU_CENTER 165
#define TOUCH_3KEY_HOME_CENTER 405
#define TOUCH_3KEY_BACK_CENTER 645

/* Touchscreen Key Positions : Y */ 
#define TOUCH_3KEY_HEIGHT        60
#define TOUCH_3KEY_TOP_GAP       15
#define TOUCH_3KEY_BOTTON_GAP    0
#define TOUCH_3KEY_MAX_YC        1280
#define TOUCH_3KEY_MAX_TOUCH_YC  1395
...
/* Firmware */
#define MXT224_FIRMWARE "mxt224.fw"
...
#define klogi_if(fmt, arg...) if (debug == DEBUG_VERBOSE) printk(KERN_INFO "%s: " fmt "\n" , __func__, ## arg)
#define kloge_if(fmt, arg...) if (debug == DEBUG_VERBOSE) printk(KERN_ERR "%s(%d): " fmt "\n" , __func__, __LINE__, ## arg)
...
struct mxt_platform_data {
	...
	void  (*init_platform_hw)(struct mxt_platform_data *);
	void  (*exit_platform_hw)(struct mxt_platform_data *);
	void  (*suspend_platform_hw)(struct mxt_platform_data *);
	void  (*resume_platform_hw)(struct mxt_platform_data *);
...
/* ADD TRACKING_ID : Google ICS spec applied at 12.04.25 */
