...
#define T38_USERDATA0             20	/* T9_TCHTHR_CAL */
#define T38_USERDATA1             5	    /* CAL_THR */
#define T38_USERDATA2             3     /* num_of_antitouch */
#define T38_USERDATA3             55	/* T9_TCHTHR_TA */
#define T38_USERDATA4             2	    /* T9_TCHDI_TA */
#define T38_USERDATA5             10	/* T9_MOVHYSTI_TA */
#define T38_USERDATA6             65	//14	/* T9_MOVFILTER_TA */
#define T38_USERDATA7             45	/* T22_NOISETHR_TA */
...
#define T9_MOVHYSTN               3
#define T9_MOVFILTER              81
#define T9_NUMTOUCH               10    
#define T9_MRGHYST                3	    
#define T9_MRGTHR                 40	
#define T9_AMPHYST                6
#define T9_XRANGE                 (1395-1) //(1024-1)
#define T9_YRANGE                 (800-1)
#define T9_XLOCLIP                5
#define T9_XHICLIP                5
#define T9_YLOCLIP                36
#define T9_YHICLIP                24
#define T9_XEDGECTRL              136 
#define T9_XEDGEDIST              40	
#define T9_YEDGECTRL              136   
#define T9_YEDGEDIST              30	
