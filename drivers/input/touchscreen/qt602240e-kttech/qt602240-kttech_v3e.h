/*
*  qt602240_kttech_v3.h - Atmel maXTouch Touchscreen Controller Header
*
*  Version 0.1a
*
...
/*For Factory*/
//#define MXT_FACTORY_TEST  0 /*for TS factory test */
#define ENABLE_NOISE_TEST_MODE	0

/* For Factory Tuning */
//#define ENABLE_FATORY_TUNING
...
//#define TSP_KEY_LED_ENABLE		/* Disabled for control Android Frameworks layer */
//#define TSP_HOME_LED_ENABLE
#define KEY_LED_TIME_OFF_DELAY	700 /* 0.7 sec after */
#define KEY_LED_DEFAULT_BRIGHTNESS	100
#define KEY_IRQ_HOME	172
...
/* Touchscreen Touch Key Positions : Y */ 
#define TOUCH_3KEY_HEIGHT        60
#define TOUCH_3KEY_TOP_GAP       60
#define TOUCH_3KEY_BOTTON_GAP    0
#define TOUCH_3KEY_MAX_YC		 960
#define TOUCH_3KEY_MAX_TOUCH_YC  1061
...
#define klogi_if(fmt, arg...) if (0) printk(KERN_INFO "%s: " fmt "\n" , __func__, ## arg)
...
struct mxt_data {
	...
	struct delayed_work  led_off_dwork;
