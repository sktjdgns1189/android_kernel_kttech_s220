...
/* TS driver configuration */
#define MELFAS_THREADED_IRQ		// Use Threaded IRQ, For safe
#undef ENABLE_INFORM_CHERGER	// Use inform charger connection, For safe
#define MELFAS_TS_USE_LOCK		// Use report locking, For safe
#undef INIT_SET_FRAMERATE		// Use set framerate at initialize 
#undef INIT_SET_CORRECTION_POS	// Use set pos correction at initialize
#undef MELFAS_USE_INPUT_MODE	// Use Input mode selection

#define INIT_LOW_DEBUG_TIME		100	// Enable low-level debug message time at initalize
#define MELFAS_SLEEP_POWEROFF
#define SET_DOWNLOAD_BY_GPIO
#define SET_RECOVERY_DOWNLOAD_BY_GPIO

#define MELFAS_MAX_TOUCH		6
#define PUB_FW_VERSION			0x20
#define PUB_FW_VERSION_LEGACY	0x1
#define CORE_FW_VERSION			0x45

/* Initialize Configuration */
#define INIT_FRAMERATE 			55
#define INIT_CORR_XPOS			0
#define INIT_CORR_X_VARIANT		0
...
#define MCS8000_I2C_SCL			36
#define MCS8000_I2C_SDA			35
...
#define TS_REG_CMD_SET_MERGE_LEVEL		0x11
#define TS_REG_CMD_SET_EDIT_MODE		0x12
#define TS_REG_CMD_SET_ESD_DETECTION	0x13
#define TS_REG_CMD_SET_CORRPOS_X		0x40
#define TS_REG_CMD_SET_CORRPOS_Y		0x80

/*Universal Command Address*/
#define UNIVERSAL_CMD							0xA0
#define UNIVERSAL_CMD_PARAM1					0xA1
#define UNIVERSAL_CMD_PARAM2					0xA2
#define UNIVERSAL_CMD_RESULT_SIZE				0xAE
#define UNIVERSAL_CMD_RESULT					0xAF

/*Universal Command ID*/
...
#define UNIVCMD_TEST_CM_JITTER					0x45
#define UNIVCMD_GET_PIXEL_CM_JITTER				0x46
#define UNIVCMD_TEST_CM_DIFF					0x47
#define UNIVCMD_GET_PIXEL_CM_DIFF				0x48
#define UNIVCMD_MODIFY_TEST_COND				0x49
#define UNIVCMD_EXIT_TEST_MODE					0x4F
#define UNIVCMD_ENTER_LOG_MODE					0x50
#define UNIVCMD_ENTER_CONFIGURATION_MODE		0x5F
...
/* 2 Touch key array */
#define	TOUCH_2KEY_MENU			0x02
#define	TOUCH_2KEY_BACK			0x01
#define TOUCH_KEY_NULL			0x03
...
#define ESD_RETRY_COUNTER_LIMIT_BOOT	1
...
struct melfas_ts_data
{
	...
	struct delayed_work            melfas_ts_report_position_dwork;
	...
	uint32_t                       disabled_esd_detection;
