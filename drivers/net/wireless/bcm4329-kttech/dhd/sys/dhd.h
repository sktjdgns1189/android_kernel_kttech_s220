...
#define KTTECH_WIFI_BCM4329_MSG
#endif
...
typedef struct dhd_pub {
	...
	int suspend_disable_flag; /* "1" to disable ` extra powersaving during suspend */
...
#ifdef CONFIG_KTTECH_WIFI_BCM4329
extern void wl_set_romm_parms( struct net_device *dev );
#endif
#endif /* _dhd_h_ */
