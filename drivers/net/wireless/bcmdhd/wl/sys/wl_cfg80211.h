 ...
 *
 * $Id: wl_cfg80211.h 311480 2012-01-30 10:35:59Z $
 */
...
extern int wl_cfg80211_get_txpower(struct net_device *dev, char *command, int total_len);
extern int wl_cfg80211_get_fer_per(struct net_device *dev, char *command, int total_len);
extern int wl_cfg80211_get_curr_freq(struct net_device *dev, char *command, int total_len);
extern int wl_cfg80211_set_roam_mode(struct net_device *dev, char *command, int total_len);
extern int wl_cfg80211_get_roam_mode(struct net_device *dev, char *command, int total_len);
#endif
