 ...
 *
 * $Id: dhd.h 313490 2012-02-07 23:28:53Z $
 */
...
// KTT UPDATE : 20101030 powerkss ADD for nv mac addr
#ifndef GET_CUSTOM_MAC_ENABLE
...
// E===================================================
    ...
    #define _DHD_PM_RESUME_WAIT(a, b) do {\
            ...
            while (dhd_mmc_suspend && retry++ != b) { \
            	SMP_RD_BARRIER_DEPENDS(); \
            	wait_event_timeout(a, !dhd_mmc_suspend, HZ/100); \
            } \
        } while (0)
#else
	#define _DHD_PM_RESUME_WAIT(a, b) do {\
