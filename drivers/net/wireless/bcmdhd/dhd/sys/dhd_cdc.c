...
// shjin - merget s300 code
// S=================================================================
#ifdef CONFIG_KTTECH_WIRELESS_BCM4330
    else if ((!ret) && (ioc->cmd == WLC_SET_VAR)
    && (!strcmp(buf, "mkeep_alive"))) {
      wl_mkeep_alive_pkt_t *ppkt;
      char *p = (char *)buf;
      p += strlen("mkeep_alive") + 1;
      ppkt = (wl_mkeep_alive_pkt_t *)p;
      dhd->mkeep_alive_pkt.period_msec = ppkt->period_msec;
   }
#endif
// E=================================================================
