...
#if 1 // kuzuri_jb add
static struct msm_camera_csi_params s5k4e5_csic_params = {
...
static struct msm_camera_csi_params *s5k4e5_csic_params_array[] = {
	&s5k4e5_csic_params,
	&s5k4e5_csic_params,
	&s5k4e5_csic_params,
};
...
static int __init msm_sensor_init_module(void)
{
  ...
  printk(" \n\n kuzuri____ msm_sensor_init_module()__ S5k4e5.c ... init module..\n\n\n");
/* Begin - jaemoon.hwang@kttech.co.kr */
/* CONFIG_CAMERA_CALIBRATION_EEPROM */
#if 1
...
// kuzuri_jb  - 8960 use sensor_setting.. 8260 use csi_setting.. 
...
static struct msm_sensor_ctrl_t s5k4e5_s_ctrl = {
	...
	.csic_params = &s5k4e5_csic_params_array[0], // kuzuri_jb add
