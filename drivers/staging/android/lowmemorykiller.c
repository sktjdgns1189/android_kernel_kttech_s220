...
// KT Tech : SEC_ADJUST_LMK it fix the problem where kswapd0 goes crazy consuming cpu and kills performance+battery
...
static int lowmem_shrink(struct shrinker *s, struct shrink_control *sc)
{
	...
	for_each_process(p) {
		...
		lowmem_print(2, "sg_select %d (%s), adj %d, size %d, to kill\n",
