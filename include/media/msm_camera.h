...
#define FEATURE_GET_WBVALUE // boba 0618
...
#define CFG_GET_CAL_DATA 40
#endif

#ifdef FEATURE_GET_WBVALUE //boba 0618
#define CFG_GET_WB_VALUE 41
#endif
#define MOVE_NEAR	0
#define MOVE_FAR	1
...
#if 1 //#ifdef CONFIG_KTTECH_CAMERA_MT9E013 // jykim 110322  // htdo_0503
#define SENSOR_1080P_SIZE		 4
#define SENSOR_FRONT_CAMCORDER_SIZE 5 // bobafett
#endif
...
#ifdef FEATURE_GET_WBVALUE //boba 0621
struct rgb_values {
 uint16_t rvalue;
 uint16_t bvalue;
};
...
struct sensor_cfg_data {
	...
	union {
		int8_t effect;
		int8_t wb;		//boba 0225, boba.kim 0529 o3_ics
